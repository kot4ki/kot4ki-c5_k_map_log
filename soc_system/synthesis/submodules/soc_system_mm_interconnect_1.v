...
module soc_system_mm_interconnect_1 (
		...
		output wire [1:0]  fsm_reset_s1_address,                                   //                                     fsm_reset_s1.address
		output wire        fsm_reset_s1_write,                                     //                                                 .write
		input  wire [31:0] fsm_reset_s1_readdata,                                  //                                                 .readdata
		output wire [31:0] fsm_reset_s1_writedata,                                 //                                                 .writedata
		output wire        fsm_reset_s1_chipselect,                                //                                                 .chipselect
		output wire [1:0]  gen_done_s1_address,                                    //                                      gen_done_s1.address
		output wire        gen_done_s1_write,                                      //                                                 .write
		input  wire [31:0] gen_done_s1_readdata,                                   //                                                 .readdata
		output wire [31:0] gen_done_s1_writedata,                                  //                                                 .writedata
		output wire        gen_done_s1_chipselect,                                 //                                                 .chipselect
		...
		output wire [1:0]  prng_out_s1_address,                                    //                                      prng_out_s1.address
		input  wire [31:0] prng_out_s1_readdata,                                   //                                                 .readdata
		output wire [1:0]  prng_start_s1_address,                                  //                                    prng_start_s1.address
		output wire        prng_start_s1_write,                                    //                                                 .write
		input  wire [31:0] prng_start_s1_readdata,                                 //                                                 .readdata
		output wire [31:0] prng_start_s1_writedata,                                //                                                 .writedata
		output wire        prng_start_s1_chipselect,                               //                                                 .chipselect
		output wire [1:0]  r_addr_s1_address,                                      //                                        r_addr_s1.address
		output wire        r_addr_s1_write,                                        //                                                 .write
		input  wire [31:0] r_addr_s1_readdata,                                     //                                                 .readdata
		output wire [31:0] r_addr_s1_writedata,                                    //                                                 .writedata
		output wire        r_addr_s1_chipselect,                                   //                                                 .chipselect
		output wire [1:0]  read_clk_s1_address,                                    //                                      read_clk_s1.address
		output wire        read_clk_s1_write,                                      //                                                 .write
		input  wire [31:0] read_clk_s1_readdata,                                   //                                                 .readdata
		output wire [31:0] read_clk_s1_writedata,                                  //                                                 .writedata
		output wire        read_clk_s1_chipselect,                                 //                                                 .chipselect
		output wire [1:0]  rec_done_s1_address,                                    //                                      rec_done_s1.address
		output wire        rec_done_s1_write,                                      //                                                 .write
		input  wire [31:0] rec_done_s1_readdata,                                   //                                                 .readdata
		output wire [31:0] rec_done_s1_writedata,                                  //                                                 .writedata
		output wire        rec_done_s1_chipselect,                                 //                                                 .chipselect
		output wire [1:0]  seed_s1_address,                                        //                                          seed_s1.address
		output wire        seed_s1_write,                                          //                                                 .write
		input  wire [31:0] seed_s1_readdata,                                       //                                                 .readdata
		output wire [31:0] seed_s1_writedata,                                      //                                                 .writedata
		output wire        seed_s1_chipselect,                                     //                                                 .chipselect
	...
	wire   [31:0] read_clk_s1_agent_m0_readdata;                                              // read_clk_s1_translator:uav_readdata -> read_clk_s1_agent:m0_readdata
	wire          read_clk_s1_agent_m0_waitrequest;                                           // read_clk_s1_translator:uav_waitrequest -> read_clk_s1_agent:m0_waitrequest
	wire          read_clk_s1_agent_m0_debugaccess;                                           // read_clk_s1_agent:m0_debugaccess -> read_clk_s1_translator:uav_debugaccess
	wire   [31:0] read_clk_s1_agent_m0_address;                                               // read_clk_s1_agent:m0_address -> read_clk_s1_translator:uav_address
	wire    [3:0] read_clk_s1_agent_m0_byteenable;                                            // read_clk_s1_agent:m0_byteenable -> read_clk_s1_translator:uav_byteenable
	wire          read_clk_s1_agent_m0_read;                                                  // read_clk_s1_agent:m0_read -> read_clk_s1_translator:uav_read
	wire          read_clk_s1_agent_m0_readdatavalid;                                         // read_clk_s1_translator:uav_readdatavalid -> read_clk_s1_agent:m0_readdatavalid
	wire          read_clk_s1_agent_m0_lock;                                                  // read_clk_s1_agent:m0_lock -> read_clk_s1_translator:uav_lock
	wire   [31:0] read_clk_s1_agent_m0_writedata;                                             // read_clk_s1_agent:m0_writedata -> read_clk_s1_translator:uav_writedata
	wire          read_clk_s1_agent_m0_write;                                                 // read_clk_s1_agent:m0_write -> read_clk_s1_translator:uav_write
	wire    [2:0] read_clk_s1_agent_m0_burstcount;                                            // read_clk_s1_agent:m0_burstcount -> read_clk_s1_translator:uav_burstcount
	wire          read_clk_s1_agent_rf_source_valid;                                          // read_clk_s1_agent:rf_source_valid -> read_clk_s1_agent_rsp_fifo:in_valid
	wire  [108:0] read_clk_s1_agent_rf_source_data;                                           // read_clk_s1_agent:rf_source_data -> read_clk_s1_agent_rsp_fifo:in_data
	wire          read_clk_s1_agent_rf_source_ready;                                          // read_clk_s1_agent_rsp_fifo:in_ready -> read_clk_s1_agent:rf_source_ready
	wire          read_clk_s1_agent_rf_source_startofpacket;                                  // read_clk_s1_agent:rf_source_startofpacket -> read_clk_s1_agent_rsp_fifo:in_startofpacket
	wire          read_clk_s1_agent_rf_source_endofpacket;                                    // read_clk_s1_agent:rf_source_endofpacket -> read_clk_s1_agent_rsp_fifo:in_endofpacket
	wire          read_clk_s1_agent_rsp_fifo_out_valid;                                       // read_clk_s1_agent_rsp_fifo:out_valid -> read_clk_s1_agent:rf_sink_valid
	wire  [108:0] read_clk_s1_agent_rsp_fifo_out_data;                                        // read_clk_s1_agent_rsp_fifo:out_data -> read_clk_s1_agent:rf_sink_data
	wire          read_clk_s1_agent_rsp_fifo_out_ready;                                       // read_clk_s1_agent:rf_sink_ready -> read_clk_s1_agent_rsp_fifo:out_ready
	wire          read_clk_s1_agent_rsp_fifo_out_startofpacket;                               // read_clk_s1_agent_rsp_fifo:out_startofpacket -> read_clk_s1_agent:rf_sink_startofpacket
	wire          read_clk_s1_agent_rsp_fifo_out_endofpacket;                                 // read_clk_s1_agent_rsp_fifo:out_endofpacket -> read_clk_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_006_src_valid;                                                      // cmd_mux_006:src_valid -> read_clk_s1_agent:cp_valid
	wire  [107:0] cmd_mux_006_src_data;                                                       // cmd_mux_006:src_data -> read_clk_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                      // read_clk_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [13:0] cmd_mux_006_src_channel;                                                    // cmd_mux_006:src_channel -> read_clk_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                              // cmd_mux_006:src_startofpacket -> read_clk_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                // cmd_mux_006:src_endofpacket -> read_clk_s1_agent:cp_endofpacket
	wire   [31:0] seed_s1_agent_m0_readdata;                                                  // seed_s1_translator:uav_readdata -> seed_s1_agent:m0_readdata
	wire          seed_s1_agent_m0_waitrequest;                                               // seed_s1_translator:uav_waitrequest -> seed_s1_agent:m0_waitrequest
	wire          seed_s1_agent_m0_debugaccess;                                               // seed_s1_agent:m0_debugaccess -> seed_s1_translator:uav_debugaccess
	wire   [31:0] seed_s1_agent_m0_address;                                                   // seed_s1_agent:m0_address -> seed_s1_translator:uav_address
	wire    [3:0] seed_s1_agent_m0_byteenable;                                                // seed_s1_agent:m0_byteenable -> seed_s1_translator:uav_byteenable
	wire          seed_s1_agent_m0_read;                                                      // seed_s1_agent:m0_read -> seed_s1_translator:uav_read
	wire          seed_s1_agent_m0_readdatavalid;                                             // seed_s1_translator:uav_readdatavalid -> seed_s1_agent:m0_readdatavalid
	wire          seed_s1_agent_m0_lock;                                                      // seed_s1_agent:m0_lock -> seed_s1_translator:uav_lock
	wire   [31:0] seed_s1_agent_m0_writedata;                                                 // seed_s1_agent:m0_writedata -> seed_s1_translator:uav_writedata
	wire          seed_s1_agent_m0_write;                                                     // seed_s1_agent:m0_write -> seed_s1_translator:uav_write
	wire    [2:0] seed_s1_agent_m0_burstcount;                                                // seed_s1_agent:m0_burstcount -> seed_s1_translator:uav_burstcount
	wire          seed_s1_agent_rf_source_valid;                                              // seed_s1_agent:rf_source_valid -> seed_s1_agent_rsp_fifo:in_valid
	wire  [108:0] seed_s1_agent_rf_source_data;                                               // seed_s1_agent:rf_source_data -> seed_s1_agent_rsp_fifo:in_data
	wire          seed_s1_agent_rf_source_ready;                                              // seed_s1_agent_rsp_fifo:in_ready -> seed_s1_agent:rf_source_ready
	wire          seed_s1_agent_rf_source_startofpacket;                                      // seed_s1_agent:rf_source_startofpacket -> seed_s1_agent_rsp_fifo:in_startofpacket
	wire          seed_s1_agent_rf_source_endofpacket;                                        // seed_s1_agent:rf_source_endofpacket -> seed_s1_agent_rsp_fifo:in_endofpacket
	wire          seed_s1_agent_rsp_fifo_out_valid;                                           // seed_s1_agent_rsp_fifo:out_valid -> seed_s1_agent:rf_sink_valid
	wire  [108:0] seed_s1_agent_rsp_fifo_out_data;                                            // seed_s1_agent_rsp_fifo:out_data -> seed_s1_agent:rf_sink_data
	wire          seed_s1_agent_rsp_fifo_out_ready;                                           // seed_s1_agent:rf_sink_ready -> seed_s1_agent_rsp_fifo:out_ready
	wire          seed_s1_agent_rsp_fifo_out_startofpacket;                                   // seed_s1_agent_rsp_fifo:out_startofpacket -> seed_s1_agent:rf_sink_startofpacket
	wire          seed_s1_agent_rsp_fifo_out_endofpacket;                                     // seed_s1_agent_rsp_fifo:out_endofpacket -> seed_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_007_src_valid;                                                      // cmd_mux_007:src_valid -> seed_s1_agent:cp_valid
	wire  [107:0] cmd_mux_007_src_data;                                                       // cmd_mux_007:src_data -> seed_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                      // seed_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [13:0] cmd_mux_007_src_channel;                                                    // cmd_mux_007:src_channel -> seed_s1_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                              // cmd_mux_007:src_startofpacket -> seed_s1_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                // cmd_mux_007:src_endofpacket -> seed_s1_agent:cp_endofpacket
	wire   [31:0] prng_out_s1_agent_m0_readdata;                                              // prng_out_s1_translator:uav_readdata -> prng_out_s1_agent:m0_readdata
	wire          prng_out_s1_agent_m0_waitrequest;                                           // prng_out_s1_translator:uav_waitrequest -> prng_out_s1_agent:m0_waitrequest
	wire          prng_out_s1_agent_m0_debugaccess;                                           // prng_out_s1_agent:m0_debugaccess -> prng_out_s1_translator:uav_debugaccess
	wire   [31:0] prng_out_s1_agent_m0_address;                                               // prng_out_s1_agent:m0_address -> prng_out_s1_translator:uav_address
	wire    [3:0] prng_out_s1_agent_m0_byteenable;                                            // prng_out_s1_agent:m0_byteenable -> prng_out_s1_translator:uav_byteenable
	wire          prng_out_s1_agent_m0_read;                                                  // prng_out_s1_agent:m0_read -> prng_out_s1_translator:uav_read
	wire          prng_out_s1_agent_m0_readdatavalid;                                         // prng_out_s1_translator:uav_readdatavalid -> prng_out_s1_agent:m0_readdatavalid
	wire          prng_out_s1_agent_m0_lock;                                                  // prng_out_s1_agent:m0_lock -> prng_out_s1_translator:uav_lock
	wire   [31:0] prng_out_s1_agent_m0_writedata;                                             // prng_out_s1_agent:m0_writedata -> prng_out_s1_translator:uav_writedata
	wire          prng_out_s1_agent_m0_write;                                                 // prng_out_s1_agent:m0_write -> prng_out_s1_translator:uav_write
	wire    [2:0] prng_out_s1_agent_m0_burstcount;                                            // prng_out_s1_agent:m0_burstcount -> prng_out_s1_translator:uav_burstcount
	wire          prng_out_s1_agent_rf_source_valid;                                          // prng_out_s1_agent:rf_source_valid -> prng_out_s1_agent_rsp_fifo:in_valid
	wire  [108:0] prng_out_s1_agent_rf_source_data;                                           // prng_out_s1_agent:rf_source_data -> prng_out_s1_agent_rsp_fifo:in_data
	wire          prng_out_s1_agent_rf_source_ready;                                          // prng_out_s1_agent_rsp_fifo:in_ready -> prng_out_s1_agent:rf_source_ready
	wire          prng_out_s1_agent_rf_source_startofpacket;                                  // prng_out_s1_agent:rf_source_startofpacket -> prng_out_s1_agent_rsp_fifo:in_startofpacket
	wire          prng_out_s1_agent_rf_source_endofpacket;                                    // prng_out_s1_agent:rf_source_endofpacket -> prng_out_s1_agent_rsp_fifo:in_endofpacket
	wire          prng_out_s1_agent_rsp_fifo_out_valid;                                       // prng_out_s1_agent_rsp_fifo:out_valid -> prng_out_s1_agent:rf_sink_valid
	wire  [108:0] prng_out_s1_agent_rsp_fifo_out_data;                                        // prng_out_s1_agent_rsp_fifo:out_data -> prng_out_s1_agent:rf_sink_data
	wire          prng_out_s1_agent_rsp_fifo_out_ready;                                       // prng_out_s1_agent:rf_sink_ready -> prng_out_s1_agent_rsp_fifo:out_ready
	wire          prng_out_s1_agent_rsp_fifo_out_startofpacket;                               // prng_out_s1_agent_rsp_fifo:out_startofpacket -> prng_out_s1_agent:rf_sink_startofpacket
	wire          prng_out_s1_agent_rsp_fifo_out_endofpacket;                                 // prng_out_s1_agent_rsp_fifo:out_endofpacket -> prng_out_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_008_src_valid;                                                      // cmd_mux_008:src_valid -> prng_out_s1_agent:cp_valid
	wire  [107:0] cmd_mux_008_src_data;                                                       // cmd_mux_008:src_data -> prng_out_s1_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                      // prng_out_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [13:0] cmd_mux_008_src_channel;                                                    // cmd_mux_008:src_channel -> prng_out_s1_agent:cp_channel
	wire          cmd_mux_008_src_startofpacket;                                              // cmd_mux_008:src_startofpacket -> prng_out_s1_agent:cp_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                                // cmd_mux_008:src_endofpacket -> prng_out_s1_agent:cp_endofpacket
	wire   [31:0] fsm_reset_s1_agent_m0_readdata;                                             // fsm_reset_s1_translator:uav_readdata -> fsm_reset_s1_agent:m0_readdata
	wire          fsm_reset_s1_agent_m0_waitrequest;                                          // fsm_reset_s1_translator:uav_waitrequest -> fsm_reset_s1_agent:m0_waitrequest
	wire          fsm_reset_s1_agent_m0_debugaccess;                                          // fsm_reset_s1_agent:m0_debugaccess -> fsm_reset_s1_translator:uav_debugaccess
	wire   [31:0] fsm_reset_s1_agent_m0_address;                                              // fsm_reset_s1_agent:m0_address -> fsm_reset_s1_translator:uav_address
	wire    [3:0] fsm_reset_s1_agent_m0_byteenable;                                           // fsm_reset_s1_agent:m0_byteenable -> fsm_reset_s1_translator:uav_byteenable
	wire          fsm_reset_s1_agent_m0_read;                                                 // fsm_reset_s1_agent:m0_read -> fsm_reset_s1_translator:uav_read
	wire          fsm_reset_s1_agent_m0_readdatavalid;                                        // fsm_reset_s1_translator:uav_readdatavalid -> fsm_reset_s1_agent:m0_readdatavalid
	wire          fsm_reset_s1_agent_m0_lock;                                                 // fsm_reset_s1_agent:m0_lock -> fsm_reset_s1_translator:uav_lock
	wire   [31:0] fsm_reset_s1_agent_m0_writedata;                                            // fsm_reset_s1_agent:m0_writedata -> fsm_reset_s1_translator:uav_writedata
	wire          fsm_reset_s1_agent_m0_write;                                                // fsm_reset_s1_agent:m0_write -> fsm_reset_s1_translator:uav_write
	wire    [2:0] fsm_reset_s1_agent_m0_burstcount;                                           // fsm_reset_s1_agent:m0_burstcount -> fsm_reset_s1_translator:uav_burstcount
	wire          fsm_reset_s1_agent_rf_source_valid;                                         // fsm_reset_s1_agent:rf_source_valid -> fsm_reset_s1_agent_rsp_fifo:in_valid
	wire  [108:0] fsm_reset_s1_agent_rf_source_data;                                          // fsm_reset_s1_agent:rf_source_data -> fsm_reset_s1_agent_rsp_fifo:in_data
	wire          fsm_reset_s1_agent_rf_source_ready;                                         // fsm_reset_s1_agent_rsp_fifo:in_ready -> fsm_reset_s1_agent:rf_source_ready
	wire          fsm_reset_s1_agent_rf_source_startofpacket;                                 // fsm_reset_s1_agent:rf_source_startofpacket -> fsm_reset_s1_agent_rsp_fifo:in_startofpacket
	wire          fsm_reset_s1_agent_rf_source_endofpacket;                                   // fsm_reset_s1_agent:rf_source_endofpacket -> fsm_reset_s1_agent_rsp_fifo:in_endofpacket
	wire          fsm_reset_s1_agent_rsp_fifo_out_valid;                                      // fsm_reset_s1_agent_rsp_fifo:out_valid -> fsm_reset_s1_agent:rf_sink_valid
	wire  [108:0] fsm_reset_s1_agent_rsp_fifo_out_data;                                       // fsm_reset_s1_agent_rsp_fifo:out_data -> fsm_reset_s1_agent:rf_sink_data
	wire          fsm_reset_s1_agent_rsp_fifo_out_ready;                                      // fsm_reset_s1_agent:rf_sink_ready -> fsm_reset_s1_agent_rsp_fifo:out_ready
	wire          fsm_reset_s1_agent_rsp_fifo_out_startofpacket;                              // fsm_reset_s1_agent_rsp_fifo:out_startofpacket -> fsm_reset_s1_agent:rf_sink_startofpacket
	wire          fsm_reset_s1_agent_rsp_fifo_out_endofpacket;                                // fsm_reset_s1_agent_rsp_fifo:out_endofpacket -> fsm_reset_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_009_src_valid;                                                      // cmd_mux_009:src_valid -> fsm_reset_s1_agent:cp_valid
	wire  [107:0] cmd_mux_009_src_data;                                                       // cmd_mux_009:src_data -> fsm_reset_s1_agent:cp_data
	wire          cmd_mux_009_src_ready;                                                      // fsm_reset_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [13:0] cmd_mux_009_src_channel;                                                    // cmd_mux_009:src_channel -> fsm_reset_s1_agent:cp_channel
	wire          cmd_mux_009_src_startofpacket;                                              // cmd_mux_009:src_startofpacket -> fsm_reset_s1_agent:cp_startofpacket
	wire          cmd_mux_009_src_endofpacket;                                                // cmd_mux_009:src_endofpacket -> fsm_reset_s1_agent:cp_endofpacket
	wire   [31:0] prng_start_s1_agent_m0_readdata;                                            // prng_start_s1_translator:uav_readdata -> prng_start_s1_agent:m0_readdata
	wire          prng_start_s1_agent_m0_waitrequest;                                         // prng_start_s1_translator:uav_waitrequest -> prng_start_s1_agent:m0_waitrequest
	wire          prng_start_s1_agent_m0_debugaccess;                                         // prng_start_s1_agent:m0_debugaccess -> prng_start_s1_translator:uav_debugaccess
	wire   [31:0] prng_start_s1_agent_m0_address;                                             // prng_start_s1_agent:m0_address -> prng_start_s1_translator:uav_address
	wire    [3:0] prng_start_s1_agent_m0_byteenable;                                          // prng_start_s1_agent:m0_byteenable -> prng_start_s1_translator:uav_byteenable
	wire          prng_start_s1_agent_m0_read;                                                // prng_start_s1_agent:m0_read -> prng_start_s1_translator:uav_read
	wire          prng_start_s1_agent_m0_readdatavalid;                                       // prng_start_s1_translator:uav_readdatavalid -> prng_start_s1_agent:m0_readdatavalid
	wire          prng_start_s1_agent_m0_lock;                                                // prng_start_s1_agent:m0_lock -> prng_start_s1_translator:uav_lock
	wire   [31:0] prng_start_s1_agent_m0_writedata;                                           // prng_start_s1_agent:m0_writedata -> prng_start_s1_translator:uav_writedata
	wire          prng_start_s1_agent_m0_write;                                               // prng_start_s1_agent:m0_write -> prng_start_s1_translator:uav_write
	wire    [2:0] prng_start_s1_agent_m0_burstcount;                                          // prng_start_s1_agent:m0_burstcount -> prng_start_s1_translator:uav_burstcount
	wire          prng_start_s1_agent_rf_source_valid;                                        // prng_start_s1_agent:rf_source_valid -> prng_start_s1_agent_rsp_fifo:in_valid
	wire  [108:0] prng_start_s1_agent_rf_source_data;                                         // prng_start_s1_agent:rf_source_data -> prng_start_s1_agent_rsp_fifo:in_data
	wire          prng_start_s1_agent_rf_source_ready;                                        // prng_start_s1_agent_rsp_fifo:in_ready -> prng_start_s1_agent:rf_source_ready
	wire          prng_start_s1_agent_rf_source_startofpacket;                                // prng_start_s1_agent:rf_source_startofpacket -> prng_start_s1_agent_rsp_fifo:in_startofpacket
	wire          prng_start_s1_agent_rf_source_endofpacket;                                  // prng_start_s1_agent:rf_source_endofpacket -> prng_start_s1_agent_rsp_fifo:in_endofpacket
	wire          prng_start_s1_agent_rsp_fifo_out_valid;                                     // prng_start_s1_agent_rsp_fifo:out_valid -> prng_start_s1_agent:rf_sink_valid
	wire  [108:0] prng_start_s1_agent_rsp_fifo_out_data;                                      // prng_start_s1_agent_rsp_fifo:out_data -> prng_start_s1_agent:rf_sink_data
	wire          prng_start_s1_agent_rsp_fifo_out_ready;                                     // prng_start_s1_agent:rf_sink_ready -> prng_start_s1_agent_rsp_fifo:out_ready
	wire          prng_start_s1_agent_rsp_fifo_out_startofpacket;                             // prng_start_s1_agent_rsp_fifo:out_startofpacket -> prng_start_s1_agent:rf_sink_startofpacket
	wire          prng_start_s1_agent_rsp_fifo_out_endofpacket;                               // prng_start_s1_agent_rsp_fifo:out_endofpacket -> prng_start_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_010_src_valid;                                                      // cmd_mux_010:src_valid -> prng_start_s1_agent:cp_valid
	wire  [107:0] cmd_mux_010_src_data;                                                       // cmd_mux_010:src_data -> prng_start_s1_agent:cp_data
	wire          cmd_mux_010_src_ready;                                                      // prng_start_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire   [13:0] cmd_mux_010_src_channel;                                                    // cmd_mux_010:src_channel -> prng_start_s1_agent:cp_channel
	wire          cmd_mux_010_src_startofpacket;                                              // cmd_mux_010:src_startofpacket -> prng_start_s1_agent:cp_startofpacket
	wire          cmd_mux_010_src_endofpacket;                                                // cmd_mux_010:src_endofpacket -> prng_start_s1_agent:cp_endofpacket
	wire   [31:0] rec_done_s1_agent_m0_readdata;                                              // rec_done_s1_translator:uav_readdata -> rec_done_s1_agent:m0_readdata
	wire          rec_done_s1_agent_m0_waitrequest;                                           // rec_done_s1_translator:uav_waitrequest -> rec_done_s1_agent:m0_waitrequest
	wire          rec_done_s1_agent_m0_debugaccess;                                           // rec_done_s1_agent:m0_debugaccess -> rec_done_s1_translator:uav_debugaccess
	wire   [31:0] rec_done_s1_agent_m0_address;                                               // rec_done_s1_agent:m0_address -> rec_done_s1_translator:uav_address
	wire    [3:0] rec_done_s1_agent_m0_byteenable;                                            // rec_done_s1_agent:m0_byteenable -> rec_done_s1_translator:uav_byteenable
	wire          rec_done_s1_agent_m0_read;                                                  // rec_done_s1_agent:m0_read -> rec_done_s1_translator:uav_read
	wire          rec_done_s1_agent_m0_readdatavalid;                                         // rec_done_s1_translator:uav_readdatavalid -> rec_done_s1_agent:m0_readdatavalid
	wire          rec_done_s1_agent_m0_lock;                                                  // rec_done_s1_agent:m0_lock -> rec_done_s1_translator:uav_lock
	wire   [31:0] rec_done_s1_agent_m0_writedata;                                             // rec_done_s1_agent:m0_writedata -> rec_done_s1_translator:uav_writedata
	wire          rec_done_s1_agent_m0_write;                                                 // rec_done_s1_agent:m0_write -> rec_done_s1_translator:uav_write
	wire    [2:0] rec_done_s1_agent_m0_burstcount;                                            // rec_done_s1_agent:m0_burstcount -> rec_done_s1_translator:uav_burstcount
	wire          rec_done_s1_agent_rf_source_valid;                                          // rec_done_s1_agent:rf_source_valid -> rec_done_s1_agent_rsp_fifo:in_valid
	wire  [108:0] rec_done_s1_agent_rf_source_data;                                           // rec_done_s1_agent:rf_source_data -> rec_done_s1_agent_rsp_fifo:in_data
	wire          rec_done_s1_agent_rf_source_ready;                                          // rec_done_s1_agent_rsp_fifo:in_ready -> rec_done_s1_agent:rf_source_ready
	wire          rec_done_s1_agent_rf_source_startofpacket;                                  // rec_done_s1_agent:rf_source_startofpacket -> rec_done_s1_agent_rsp_fifo:in_startofpacket
	wire          rec_done_s1_agent_rf_source_endofpacket;                                    // rec_done_s1_agent:rf_source_endofpacket -> rec_done_s1_agent_rsp_fifo:in_endofpacket
	wire          rec_done_s1_agent_rsp_fifo_out_valid;                                       // rec_done_s1_agent_rsp_fifo:out_valid -> rec_done_s1_agent:rf_sink_valid
	wire  [108:0] rec_done_s1_agent_rsp_fifo_out_data;                                        // rec_done_s1_agent_rsp_fifo:out_data -> rec_done_s1_agent:rf_sink_data
	wire          rec_done_s1_agent_rsp_fifo_out_ready;                                       // rec_done_s1_agent:rf_sink_ready -> rec_done_s1_agent_rsp_fifo:out_ready
	wire          rec_done_s1_agent_rsp_fifo_out_startofpacket;                               // rec_done_s1_agent_rsp_fifo:out_startofpacket -> rec_done_s1_agent:rf_sink_startofpacket
	wire          rec_done_s1_agent_rsp_fifo_out_endofpacket;                                 // rec_done_s1_agent_rsp_fifo:out_endofpacket -> rec_done_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_011_src_valid;                                                      // cmd_mux_011:src_valid -> rec_done_s1_agent:cp_valid
	wire  [107:0] cmd_mux_011_src_data;                                                       // cmd_mux_011:src_data -> rec_done_s1_agent:cp_data
	wire          cmd_mux_011_src_ready;                                                      // rec_done_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire   [13:0] cmd_mux_011_src_channel;                                                    // cmd_mux_011:src_channel -> rec_done_s1_agent:cp_channel
	wire          cmd_mux_011_src_startofpacket;                                              // cmd_mux_011:src_startofpacket -> rec_done_s1_agent:cp_startofpacket
	wire          cmd_mux_011_src_endofpacket;                                                // cmd_mux_011:src_endofpacket -> rec_done_s1_agent:cp_endofpacket
	wire   [31:0] r_addr_s1_agent_m0_readdata;                                                // r_addr_s1_translator:uav_readdata -> r_addr_s1_agent:m0_readdata
	wire          r_addr_s1_agent_m0_waitrequest;                                             // r_addr_s1_translator:uav_waitrequest -> r_addr_s1_agent:m0_waitrequest
	wire          r_addr_s1_agent_m0_debugaccess;                                             // r_addr_s1_agent:m0_debugaccess -> r_addr_s1_translator:uav_debugaccess
	wire   [31:0] r_addr_s1_agent_m0_address;                                                 // r_addr_s1_agent:m0_address -> r_addr_s1_translator:uav_address
	wire    [3:0] r_addr_s1_agent_m0_byteenable;                                              // r_addr_s1_agent:m0_byteenable -> r_addr_s1_translator:uav_byteenable
	wire          r_addr_s1_agent_m0_read;                                                    // r_addr_s1_agent:m0_read -> r_addr_s1_translator:uav_read
	wire          r_addr_s1_agent_m0_readdatavalid;                                           // r_addr_s1_translator:uav_readdatavalid -> r_addr_s1_agent:m0_readdatavalid
	wire          r_addr_s1_agent_m0_lock;                                                    // r_addr_s1_agent:m0_lock -> r_addr_s1_translator:uav_lock
	wire   [31:0] r_addr_s1_agent_m0_writedata;                                               // r_addr_s1_agent:m0_writedata -> r_addr_s1_translator:uav_writedata
	wire          r_addr_s1_agent_m0_write;                                                   // r_addr_s1_agent:m0_write -> r_addr_s1_translator:uav_write
	wire    [2:0] r_addr_s1_agent_m0_burstcount;                                              // r_addr_s1_agent:m0_burstcount -> r_addr_s1_translator:uav_burstcount
	wire          r_addr_s1_agent_rf_source_valid;                                            // r_addr_s1_agent:rf_source_valid -> r_addr_s1_agent_rsp_fifo:in_valid
	wire  [108:0] r_addr_s1_agent_rf_source_data;                                             // r_addr_s1_agent:rf_source_data -> r_addr_s1_agent_rsp_fifo:in_data
	wire          r_addr_s1_agent_rf_source_ready;                                            // r_addr_s1_agent_rsp_fifo:in_ready -> r_addr_s1_agent:rf_source_ready
	wire          r_addr_s1_agent_rf_source_startofpacket;                                    // r_addr_s1_agent:rf_source_startofpacket -> r_addr_s1_agent_rsp_fifo:in_startofpacket
	wire          r_addr_s1_agent_rf_source_endofpacket;                                      // r_addr_s1_agent:rf_source_endofpacket -> r_addr_s1_agent_rsp_fifo:in_endofpacket
	wire          r_addr_s1_agent_rsp_fifo_out_valid;                                         // r_addr_s1_agent_rsp_fifo:out_valid -> r_addr_s1_agent:rf_sink_valid
	wire  [108:0] r_addr_s1_agent_rsp_fifo_out_data;                                          // r_addr_s1_agent_rsp_fifo:out_data -> r_addr_s1_agent:rf_sink_data
	wire          r_addr_s1_agent_rsp_fifo_out_ready;                                         // r_addr_s1_agent:rf_sink_ready -> r_addr_s1_agent_rsp_fifo:out_ready
	wire          r_addr_s1_agent_rsp_fifo_out_startofpacket;                                 // r_addr_s1_agent_rsp_fifo:out_startofpacket -> r_addr_s1_agent:rf_sink_startofpacket
	wire          r_addr_s1_agent_rsp_fifo_out_endofpacket;                                   // r_addr_s1_agent_rsp_fifo:out_endofpacket -> r_addr_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_012_src_valid;                                                      // cmd_mux_012:src_valid -> r_addr_s1_agent:cp_valid
	wire  [107:0] cmd_mux_012_src_data;                                                       // cmd_mux_012:src_data -> r_addr_s1_agent:cp_data
	wire          cmd_mux_012_src_ready;                                                      // r_addr_s1_agent:cp_ready -> cmd_mux_012:src_ready
	wire   [13:0] cmd_mux_012_src_channel;                                                    // cmd_mux_012:src_channel -> r_addr_s1_agent:cp_channel
	wire          cmd_mux_012_src_startofpacket;                                              // cmd_mux_012:src_startofpacket -> r_addr_s1_agent:cp_startofpacket
	wire          cmd_mux_012_src_endofpacket;                                                // cmd_mux_012:src_endofpacket -> r_addr_s1_agent:cp_endofpacket
	wire   [31:0] gen_done_s1_agent_m0_readdata;                                              // gen_done_s1_translator:uav_readdata -> gen_done_s1_agent:m0_readdata
	wire          gen_done_s1_agent_m0_waitrequest;                                           // gen_done_s1_translator:uav_waitrequest -> gen_done_s1_agent:m0_waitrequest
	wire          gen_done_s1_agent_m0_debugaccess;                                           // gen_done_s1_agent:m0_debugaccess -> gen_done_s1_translator:uav_debugaccess
	wire   [31:0] gen_done_s1_agent_m0_address;                                               // gen_done_s1_agent:m0_address -> gen_done_s1_translator:uav_address
	wire    [3:0] gen_done_s1_agent_m0_byteenable;                                            // gen_done_s1_agent:m0_byteenable -> gen_done_s1_translator:uav_byteenable
	wire          gen_done_s1_agent_m0_read;                                                  // gen_done_s1_agent:m0_read -> gen_done_s1_translator:uav_read
	wire          gen_done_s1_agent_m0_readdatavalid;                                         // gen_done_s1_translator:uav_readdatavalid -> gen_done_s1_agent:m0_readdatavalid
	wire          gen_done_s1_agent_m0_lock;                                                  // gen_done_s1_agent:m0_lock -> gen_done_s1_translator:uav_lock
	wire   [31:0] gen_done_s1_agent_m0_writedata;                                             // gen_done_s1_agent:m0_writedata -> gen_done_s1_translator:uav_writedata
	wire          gen_done_s1_agent_m0_write;                                                 // gen_done_s1_agent:m0_write -> gen_done_s1_translator:uav_write
	wire    [2:0] gen_done_s1_agent_m0_burstcount;                                            // gen_done_s1_agent:m0_burstcount -> gen_done_s1_translator:uav_burstcount
	wire          gen_done_s1_agent_rf_source_valid;                                          // gen_done_s1_agent:rf_source_valid -> gen_done_s1_agent_rsp_fifo:in_valid
	wire  [108:0] gen_done_s1_agent_rf_source_data;                                           // gen_done_s1_agent:rf_source_data -> gen_done_s1_agent_rsp_fifo:in_data
	wire          gen_done_s1_agent_rf_source_ready;                                          // gen_done_s1_agent_rsp_fifo:in_ready -> gen_done_s1_agent:rf_source_ready
	wire          gen_done_s1_agent_rf_source_startofpacket;                                  // gen_done_s1_agent:rf_source_startofpacket -> gen_done_s1_agent_rsp_fifo:in_startofpacket
	wire          gen_done_s1_agent_rf_source_endofpacket;                                    // gen_done_s1_agent:rf_source_endofpacket -> gen_done_s1_agent_rsp_fifo:in_endofpacket
	wire          gen_done_s1_agent_rsp_fifo_out_valid;                                       // gen_done_s1_agent_rsp_fifo:out_valid -> gen_done_s1_agent:rf_sink_valid
	wire  [108:0] gen_done_s1_agent_rsp_fifo_out_data;                                        // gen_done_s1_agent_rsp_fifo:out_data -> gen_done_s1_agent:rf_sink_data
	wire          gen_done_s1_agent_rsp_fifo_out_ready;                                       // gen_done_s1_agent:rf_sink_ready -> gen_done_s1_agent_rsp_fifo:out_ready
	wire          gen_done_s1_agent_rsp_fifo_out_startofpacket;                               // gen_done_s1_agent_rsp_fifo:out_startofpacket -> gen_done_s1_agent:rf_sink_startofpacket
	wire          gen_done_s1_agent_rsp_fifo_out_endofpacket;                                 // gen_done_s1_agent_rsp_fifo:out_endofpacket -> gen_done_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_013_src_valid;                                                      // cmd_mux_013:src_valid -> gen_done_s1_agent:cp_valid
	wire  [107:0] cmd_mux_013_src_data;                                                       // cmd_mux_013:src_data -> gen_done_s1_agent:cp_data
	wire          cmd_mux_013_src_ready;                                                      // gen_done_s1_agent:cp_ready -> cmd_mux_013:src_ready
	wire   [13:0] cmd_mux_013_src_channel;                                                    // cmd_mux_013:src_channel -> gen_done_s1_agent:cp_channel
	wire          cmd_mux_013_src_startofpacket;                                              // cmd_mux_013:src_startofpacket -> gen_done_s1_agent:cp_startofpacket
	wire          cmd_mux_013_src_endofpacket;                                                // cmd_mux_013:src_endofpacket -> gen_done_s1_agent:cp_endofpacket
	...
	wire          read_clk_s1_agent_rp_valid;                                                 // read_clk_s1_agent:rp_valid -> router_008:sink_valid
	wire  [107:0] read_clk_s1_agent_rp_data;                                                  // read_clk_s1_agent:rp_data -> router_008:sink_data
	wire          read_clk_s1_agent_rp_ready;                                                 // router_008:sink_ready -> read_clk_s1_agent:rp_ready
	wire          read_clk_s1_agent_rp_startofpacket;                                         // read_clk_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          read_clk_s1_agent_rp_endofpacket;                                           // read_clk_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          seed_s1_agent_rp_valid;                                                     // seed_s1_agent:rp_valid -> router_009:sink_valid
	wire  [107:0] seed_s1_agent_rp_data;                                                      // seed_s1_agent:rp_data -> router_009:sink_data
	wire          seed_s1_agent_rp_ready;                                                     // router_009:sink_ready -> seed_s1_agent:rp_ready
	wire          seed_s1_agent_rp_startofpacket;                                             // seed_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          seed_s1_agent_rp_endofpacket;                                               // seed_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire          prng_out_s1_agent_rp_valid;                                                 // prng_out_s1_agent:rp_valid -> router_010:sink_valid
	wire  [107:0] prng_out_s1_agent_rp_data;                                                  // prng_out_s1_agent:rp_data -> router_010:sink_data
	wire          prng_out_s1_agent_rp_ready;                                                 // router_010:sink_ready -> prng_out_s1_agent:rp_ready
	wire          prng_out_s1_agent_rp_startofpacket;                                         // prng_out_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire          prng_out_s1_agent_rp_endofpacket;                                           // prng_out_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire          fsm_reset_s1_agent_rp_valid;                                                // fsm_reset_s1_agent:rp_valid -> router_011:sink_valid
	wire  [107:0] fsm_reset_s1_agent_rp_data;                                                 // fsm_reset_s1_agent:rp_data -> router_011:sink_data
	wire          fsm_reset_s1_agent_rp_ready;                                                // router_011:sink_ready -> fsm_reset_s1_agent:rp_ready
	wire          fsm_reset_s1_agent_rp_startofpacket;                                        // fsm_reset_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire          fsm_reset_s1_agent_rp_endofpacket;                                          // fsm_reset_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire          prng_start_s1_agent_rp_valid;                                               // prng_start_s1_agent:rp_valid -> router_012:sink_valid
	wire  [107:0] prng_start_s1_agent_rp_data;                                                // prng_start_s1_agent:rp_data -> router_012:sink_data
	wire          prng_start_s1_agent_rp_ready;                                               // router_012:sink_ready -> prng_start_s1_agent:rp_ready
	wire          prng_start_s1_agent_rp_startofpacket;                                       // prng_start_s1_agent:rp_startofpacket -> router_012:sink_startofpacket
	wire          prng_start_s1_agent_rp_endofpacket;                                         // prng_start_s1_agent:rp_endofpacket -> router_012:sink_endofpacket
	...
	wire          rec_done_s1_agent_rp_valid;                                                 // rec_done_s1_agent:rp_valid -> router_013:sink_valid
	wire  [107:0] rec_done_s1_agent_rp_data;                                                  // rec_done_s1_agent:rp_data -> router_013:sink_data
	wire          rec_done_s1_agent_rp_ready;                                                 // router_013:sink_ready -> rec_done_s1_agent:rp_ready
	wire          rec_done_s1_agent_rp_startofpacket;                                         // rec_done_s1_agent:rp_startofpacket -> router_013:sink_startofpacket
	wire          rec_done_s1_agent_rp_endofpacket;                                           // rec_done_s1_agent:rp_endofpacket -> router_013:sink_endofpacket
	...
	wire          r_addr_s1_agent_rp_valid;                                                   // r_addr_s1_agent:rp_valid -> router_014:sink_valid
	wire  [107:0] r_addr_s1_agent_rp_data;                                                    // r_addr_s1_agent:rp_data -> router_014:sink_data
	wire          r_addr_s1_agent_rp_ready;                                                   // router_014:sink_ready -> r_addr_s1_agent:rp_ready
	wire          r_addr_s1_agent_rp_startofpacket;                                           // r_addr_s1_agent:rp_startofpacket -> router_014:sink_startofpacket
	wire          r_addr_s1_agent_rp_endofpacket;                                             // r_addr_s1_agent:rp_endofpacket -> router_014:sink_endofpacket
	...
	wire          gen_done_s1_agent_rp_valid;                                                 // gen_done_s1_agent:rp_valid -> router_015:sink_valid
	wire  [107:0] gen_done_s1_agent_rp_data;                                                  // gen_done_s1_agent:rp_data -> router_015:sink_data
	wire          gen_done_s1_agent_rp_ready;                                                 // router_015:sink_ready -> gen_done_s1_agent:rp_ready
	wire          gen_done_s1_agent_rp_startofpacket;                                         // gen_done_s1_agent:rp_startofpacket -> router_015:sink_startofpacket
	wire          gen_done_s1_agent_rp_endofpacket;                                           // gen_done_s1_agent:rp_endofpacket -> router_015:sink_endofpacket
	...
	wire          read_clk_s1_agent_rdata_fifo_src_valid;                                     // read_clk_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] read_clk_s1_agent_rdata_fifo_src_data;                                      // read_clk_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          read_clk_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_006:in_0_ready -> read_clk_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                          // avalon_st_adapter_006:out_0_valid -> read_clk_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                           // avalon_st_adapter_006:out_0_data -> read_clk_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                          // read_clk_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                          // avalon_st_adapter_006:out_0_error -> read_clk_s1_agent:rdata_fifo_sink_error
	wire          seed_s1_agent_rdata_fifo_src_valid;                                         // seed_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] seed_s1_agent_rdata_fifo_src_data;                                          // seed_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          seed_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_007:in_0_ready -> seed_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                          // avalon_st_adapter_007:out_0_valid -> seed_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                           // avalon_st_adapter_007:out_0_data -> seed_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                          // seed_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                          // avalon_st_adapter_007:out_0_error -> seed_s1_agent:rdata_fifo_sink_error
	wire          prng_out_s1_agent_rdata_fifo_src_valid;                                     // prng_out_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] prng_out_s1_agent_rdata_fifo_src_data;                                      // prng_out_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire          prng_out_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_008:in_0_ready -> prng_out_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_008_out_0_valid;                                          // avalon_st_adapter_008:out_0_valid -> prng_out_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_008_out_0_data;                                           // avalon_st_adapter_008:out_0_data -> prng_out_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_008_out_0_ready;                                          // prng_out_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire    [0:0] avalon_st_adapter_008_out_0_error;                                          // avalon_st_adapter_008:out_0_error -> prng_out_s1_agent:rdata_fifo_sink_error
	wire          fsm_reset_s1_agent_rdata_fifo_src_valid;                                    // fsm_reset_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_009:in_0_valid
	wire   [33:0] fsm_reset_s1_agent_rdata_fifo_src_data;                                     // fsm_reset_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_009:in_0_data
	wire          fsm_reset_s1_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_009:in_0_ready -> fsm_reset_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_009_out_0_valid;                                          // avalon_st_adapter_009:out_0_valid -> fsm_reset_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_009_out_0_data;                                           // avalon_st_adapter_009:out_0_data -> fsm_reset_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_009_out_0_ready;                                          // fsm_reset_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire    [0:0] avalon_st_adapter_009_out_0_error;                                          // avalon_st_adapter_009:out_0_error -> fsm_reset_s1_agent:rdata_fifo_sink_error
	wire          prng_start_s1_agent_rdata_fifo_src_valid;                                   // prng_start_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_010:in_0_valid
	wire   [33:0] prng_start_s1_agent_rdata_fifo_src_data;                                    // prng_start_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_010:in_0_data
	wire          prng_start_s1_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_010:in_0_ready -> prng_start_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_010_out_0_valid;                                          // avalon_st_adapter_010:out_0_valid -> prng_start_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_010_out_0_data;                                           // avalon_st_adapter_010:out_0_data -> prng_start_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_010_out_0_ready;                                          // prng_start_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_010:out_0_ready
	wire    [0:0] avalon_st_adapter_010_out_0_error;                                          // avalon_st_adapter_010:out_0_error -> prng_start_s1_agent:rdata_fifo_sink_error
	wire          rec_done_s1_agent_rdata_fifo_src_valid;                                     // rec_done_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_011:in_0_valid
	wire   [33:0] rec_done_s1_agent_rdata_fifo_src_data;                                      // rec_done_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_011:in_0_data
	wire          rec_done_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_011:in_0_ready -> rec_done_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_011_out_0_valid;                                          // avalon_st_adapter_011:out_0_valid -> rec_done_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_011_out_0_data;                                           // avalon_st_adapter_011:out_0_data -> rec_done_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_011_out_0_ready;                                          // rec_done_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_011:out_0_ready
	wire    [0:0] avalon_st_adapter_011_out_0_error;                                          // avalon_st_adapter_011:out_0_error -> rec_done_s1_agent:rdata_fifo_sink_error
	wire          r_addr_s1_agent_rdata_fifo_src_valid;                                       // r_addr_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_012:in_0_valid
	wire   [33:0] r_addr_s1_agent_rdata_fifo_src_data;                                        // r_addr_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_012:in_0_data
	wire          r_addr_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_012:in_0_ready -> r_addr_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_012_out_0_valid;                                          // avalon_st_adapter_012:out_0_valid -> r_addr_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_012_out_0_data;                                           // avalon_st_adapter_012:out_0_data -> r_addr_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_012_out_0_ready;                                          // r_addr_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_012:out_0_ready
	wire    [0:0] avalon_st_adapter_012_out_0_error;                                          // avalon_st_adapter_012:out_0_error -> r_addr_s1_agent:rdata_fifo_sink_error
	wire          gen_done_s1_agent_rdata_fifo_src_valid;                                     // gen_done_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_013:in_0_valid
	wire   [33:0] gen_done_s1_agent_rdata_fifo_src_data;                                      // gen_done_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_013:in_0_data
	wire          gen_done_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_013:in_0_ready -> gen_done_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_013_out_0_valid;                                          // avalon_st_adapter_013:out_0_valid -> gen_done_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_013_out_0_data;                                           // avalon_st_adapter_013:out_0_data -> gen_done_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_013_out_0_ready;                                          // gen_done_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_013:out_0_ready
	wire    [0:0] avalon_st_adapter_013_out_0_error;                                          // avalon_st_adapter_013:out_0_error -> gen_done_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) read_clk_s1_translator (
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (mm_bridge_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (read_clk_s1_agent_m0_address),                  // avalon_universal_slave_0.address
		.uav_burstcount         (read_clk_s1_agent_m0_burstcount),               //                         .burstcount
		.uav_read               (read_clk_s1_agent_m0_read),                     //                         .read
		.uav_write              (read_clk_s1_agent_m0_write),                    //                         .write
		.uav_waitrequest        (read_clk_s1_agent_m0_waitrequest),              //                         .waitrequest
		.uav_readdatavalid      (read_clk_s1_agent_m0_readdatavalid),            //                         .readdatavalid
		.uav_byteenable         (read_clk_s1_agent_m0_byteenable),               //                         .byteenable
		.uav_readdata           (read_clk_s1_agent_m0_readdata),                 //                         .readdata
		.uav_writedata          (read_clk_s1_agent_m0_writedata),                //                         .writedata
		.uav_lock               (read_clk_s1_agent_m0_lock),                     //                         .lock
		.uav_debugaccess        (read_clk_s1_agent_m0_debugaccess),              //                         .debugaccess
		.av_address             (read_clk_s1_address),                           //      avalon_anti_slave_0.address
		.av_write               (read_clk_s1_write),                             //                         .write
		.av_readdata            (read_clk_s1_readdata),                          //                         .readdata
		.av_writedata           (read_clk_s1_writedata),                         //                         .writedata
		.av_chipselect          (read_clk_s1_chipselect),                        //                         .chipselect
		.av_read                (),                                              //              (terminated)
		.av_begintransfer       (),                                              //              (terminated)
		.av_beginbursttransfer  (),                                              //              (terminated)
		.av_burstcount          (),                                              //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (mm_bridge_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (seed_s1_agent_m0_address),                      // avalon_universal_slave_0.address
		.uav_burstcount         (seed_s1_agent_m0_burstcount),                   //                         .burstcount
		.uav_read               (seed_s1_agent_m0_read),                         //                         .read
		.uav_write              (seed_s1_agent_m0_write),                        //                         .write
		.uav_waitrequest        (seed_s1_agent_m0_waitrequest),                  //                         .waitrequest
		.uav_readdatavalid      (seed_s1_agent_m0_readdatavalid),                //                         .readdatavalid
		.uav_byteenable         (seed_s1_agent_m0_byteenable),                   //                         .byteenable
		.uav_readdata           (seed_s1_agent_m0_readdata),                     //                         .readdata
		.uav_writedata          (seed_s1_agent_m0_writedata),                    //                         .writedata
		.uav_lock               (seed_s1_agent_m0_lock),                         //                         .lock
		.uav_debugaccess        (seed_s1_agent_m0_debugaccess),                  //                         .debugaccess
		.av_address             (seed_s1_address),                               //      avalon_anti_slave_0.address
		.av_write               (seed_s1_write),                                 //                         .write
		.av_readdata            (seed_s1_readdata),                              //                         .readdata
		.av_writedata           (seed_s1_writedata),                             //                         .writedata
		.av_chipselect          (seed_s1_chipselect),                            //                         .chipselect
		.av_read                (),                                              //              (terminated)
		.av_begintransfer       (),                                              //              (terminated)
		.av_beginbursttransfer  (),                                              //              (terminated)
		.av_burstcount          (),                                              //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) prng_out_s1_translator (
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (mm_bridge_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (prng_out_s1_agent_m0_address),                  // avalon_universal_slave_0.address
		.uav_burstcount         (prng_out_s1_agent_m0_burstcount),               //                         .burstcount
		.uav_read               (prng_out_s1_agent_m0_read),                     //                         .read
		.uav_write              (prng_out_s1_agent_m0_write),                    //                         .write
		.uav_waitrequest        (prng_out_s1_agent_m0_waitrequest),              //                         .waitrequest
		.uav_readdatavalid      (prng_out_s1_agent_m0_readdatavalid),            //                         .readdatavalid
		.uav_byteenable         (prng_out_s1_agent_m0_byteenable),               //                         .byteenable
		.uav_readdata           (prng_out_s1_agent_m0_readdata),                 //                         .readdata
		.uav_writedata          (prng_out_s1_agent_m0_writedata),                //                         .writedata
		.uav_lock               (prng_out_s1_agent_m0_lock),                     //                         .lock
		.uav_debugaccess        (prng_out_s1_agent_m0_debugaccess),              //                         .debugaccess
		.av_address             (prng_out_s1_address),                           //      avalon_anti_slave_0.address
		.av_readdata            (prng_out_s1_readdata),                          //                         .readdata
		.av_write               (),                                              //              (terminated)
		.av_read                (),                                              //              (terminated)
		.av_writedata           (),                                              //              (terminated)
		.av_begintransfer       (),                                              //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) fsm_reset_s1_translator (
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (mm_bridge_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (fsm_reset_s1_agent_m0_address),                 // avalon_universal_slave_0.address
		.uav_burstcount         (fsm_reset_s1_agent_m0_burstcount),              //                         .burstcount
		.uav_read               (fsm_reset_s1_agent_m0_read),                    //                         .read
		.uav_write              (fsm_reset_s1_agent_m0_write),                   //                         .write
		.uav_waitrequest        (fsm_reset_s1_agent_m0_waitrequest),             //                         .waitrequest
		.uav_readdatavalid      (fsm_reset_s1_agent_m0_readdatavalid),           //                         .readdatavalid
		.uav_byteenable         (fsm_reset_s1_agent_m0_byteenable),              //                         .byteenable
		.uav_readdata           (fsm_reset_s1_agent_m0_readdata),                //                         .readdata
		.uav_writedata          (fsm_reset_s1_agent_m0_writedata),               //                         .writedata
		.uav_lock               (fsm_reset_s1_agent_m0_lock),                    //                         .lock
		.uav_debugaccess        (fsm_reset_s1_agent_m0_debugaccess),             //                         .debugaccess
		.av_address             (fsm_reset_s1_address),                          //      avalon_anti_slave_0.address
		.av_write               (fsm_reset_s1_write),                            //                         .write
		.av_readdata            (fsm_reset_s1_readdata),                         //                         .readdata
		.av_writedata           (fsm_reset_s1_writedata),                        //                         .writedata
		.av_chipselect          (fsm_reset_s1_chipselect),                       //                         .chipselect
		.av_read                (),                                              //              (terminated)
		.av_begintransfer       (),                                              //              (terminated)
		.av_beginbursttransfer  (),                                              //              (terminated)
		.av_burstcount          (),                                              //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) prng_start_s1_translator (
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (mm_bridge_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (prng_start_s1_agent_m0_address),                // avalon_universal_slave_0.address
		.uav_burstcount         (prng_start_s1_agent_m0_burstcount),             //                         .burstcount
		.uav_read               (prng_start_s1_agent_m0_read),                   //                         .read
		.uav_write              (prng_start_s1_agent_m0_write),                  //                         .write
		.uav_waitrequest        (prng_start_s1_agent_m0_waitrequest),            //                         .waitrequest
		.uav_readdatavalid      (prng_start_s1_agent_m0_readdatavalid),          //                         .readdatavalid
		.uav_byteenable         (prng_start_s1_agent_m0_byteenable),             //                         .byteenable
		.uav_readdata           (prng_start_s1_agent_m0_readdata),               //                         .readdata
		.uav_writedata          (prng_start_s1_agent_m0_writedata),              //                         .writedata
		.uav_lock               (prng_start_s1_agent_m0_lock),                   //                         .lock
		.uav_debugaccess        (prng_start_s1_agent_m0_debugaccess),            //                         .debugaccess
		.av_address             (prng_start_s1_address),                         //      avalon_anti_slave_0.address
		.av_write               (prng_start_s1_write),                           //                         .write
		.av_readdata            (prng_start_s1_readdata),                        //                         .readdata
		.av_writedata           (prng_start_s1_writedata),                       //                         .writedata
		.av_chipselect          (prng_start_s1_chipselect),                      //                         .chipselect
		.av_read                (),                                              //              (terminated)
		.av_begintransfer       (),                                              //              (terminated)
		.av_beginbursttransfer  (),                                              //              (terminated)
		.av_burstcount          (),                                              //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) rec_done_s1_translator (
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (mm_bridge_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (rec_done_s1_agent_m0_address),                  // avalon_universal_slave_0.address
		.uav_burstcount         (rec_done_s1_agent_m0_burstcount),               //                         .burstcount
		.uav_read               (rec_done_s1_agent_m0_read),                     //                         .read
		.uav_write              (rec_done_s1_agent_m0_write),                    //                         .write
		.uav_waitrequest        (rec_done_s1_agent_m0_waitrequest),              //                         .waitrequest
		.uav_readdatavalid      (rec_done_s1_agent_m0_readdatavalid),            //                         .readdatavalid
		.uav_byteenable         (rec_done_s1_agent_m0_byteenable),               //                         .byteenable
		.uav_readdata           (rec_done_s1_agent_m0_readdata),                 //                         .readdata
		.uav_writedata          (rec_done_s1_agent_m0_writedata),                //                         .writedata
		.uav_lock               (rec_done_s1_agent_m0_lock),                     //                         .lock
		.uav_debugaccess        (rec_done_s1_agent_m0_debugaccess),              //                         .debugaccess
		.av_address             (rec_done_s1_address),                           //      avalon_anti_slave_0.address
		.av_write               (rec_done_s1_write),                             //                         .write
		.av_readdata            (rec_done_s1_readdata),                          //                         .readdata
		.av_writedata           (rec_done_s1_writedata),                         //                         .writedata
		.av_chipselect          (rec_done_s1_chipselect),                        //                         .chipselect
		.av_read                (),                                              //              (terminated)
		.av_begintransfer       (),                                              //              (terminated)
		.av_beginbursttransfer  (),                                              //              (terminated)
		.av_burstcount          (),                                              //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) r_addr_s1_translator (
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (mm_bridge_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (r_addr_s1_agent_m0_address),                    // avalon_universal_slave_0.address
		.uav_burstcount         (r_addr_s1_agent_m0_burstcount),                 //                         .burstcount
		.uav_read               (r_addr_s1_agent_m0_read),                       //                         .read
		.uav_write              (r_addr_s1_agent_m0_write),                      //                         .write
		.uav_waitrequest        (r_addr_s1_agent_m0_waitrequest),                //                         .waitrequest
		.uav_readdatavalid      (r_addr_s1_agent_m0_readdatavalid),              //                         .readdatavalid
		.uav_byteenable         (r_addr_s1_agent_m0_byteenable),                 //                         .byteenable
		.uav_readdata           (r_addr_s1_agent_m0_readdata),                   //                         .readdata
		.uav_writedata          (r_addr_s1_agent_m0_writedata),                  //                         .writedata
		.uav_lock               (r_addr_s1_agent_m0_lock),                       //                         .lock
		.uav_debugaccess        (r_addr_s1_agent_m0_debugaccess),                //                         .debugaccess
		.av_address             (r_addr_s1_address),                             //      avalon_anti_slave_0.address
		.av_write               (r_addr_s1_write),                               //                         .write
		.av_readdata            (r_addr_s1_readdata),                            //                         .readdata
		.av_writedata           (r_addr_s1_writedata),                           //                         .writedata
		.av_chipselect          (r_addr_s1_chipselect),                          //                         .chipselect
		.av_read                (),                                              //              (terminated)
		.av_begintransfer       (),                                              //              (terminated)
		.av_beginbursttransfer  (),                                              //              (terminated)
		.av_burstcount          (),                                              //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) gen_done_s1_translator (
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (mm_bridge_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (gen_done_s1_agent_m0_address),                  // avalon_universal_slave_0.address
		.uav_burstcount         (gen_done_s1_agent_m0_burstcount),               //                         .burstcount
		.uav_read               (gen_done_s1_agent_m0_read),                     //                         .read
		.uav_write              (gen_done_s1_agent_m0_write),                    //                         .write
		.uav_waitrequest        (gen_done_s1_agent_m0_waitrequest),              //                         .waitrequest
		.uav_readdatavalid      (gen_done_s1_agent_m0_readdatavalid),            //                         .readdatavalid
		.uav_byteenable         (gen_done_s1_agent_m0_byteenable),               //                         .byteenable
		.uav_readdata           (gen_done_s1_agent_m0_readdata),                 //                         .readdata
		.uav_writedata          (gen_done_s1_agent_m0_writedata),                //                         .writedata
		.uav_lock               (gen_done_s1_agent_m0_lock),                     //                         .lock
		.uav_debugaccess        (gen_done_s1_agent_m0_debugaccess),              //                         .debugaccess
		.av_address             (gen_done_s1_address),                           //      avalon_anti_slave_0.address
		.av_write               (gen_done_s1_write),                             //                         .write
		.av_readdata            (gen_done_s1_readdata),                          //                         .readdata
		.av_writedata           (gen_done_s1_writedata),                         //                         .writedata
		.av_chipselect          (gen_done_s1_chipselect),                        //                         .chipselect
		.av_read                (),                                              //              (terminated)
		.av_begintransfer       (),                                              //              (terminated)
		.av_beginbursttransfer  (),                                              //              (terminated)
		.av_burstcount          (),                                              //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                 //             clk.clk
		.reset                   (mm_bridge_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (read_clk_s1_agent_m0_address),                  //              m0.address
		.m0_burstcount           (read_clk_s1_agent_m0_burstcount),               //                .burstcount
		.m0_byteenable           (read_clk_s1_agent_m0_byteenable),               //                .byteenable
		.m0_debugaccess          (read_clk_s1_agent_m0_debugaccess),              //                .debugaccess
		.m0_lock                 (read_clk_s1_agent_m0_lock),                     //                .lock
		.m0_readdata             (read_clk_s1_agent_m0_readdata),                 //                .readdata
		.m0_readdatavalid        (read_clk_s1_agent_m0_readdatavalid),            //                .readdatavalid
		.m0_read                 (read_clk_s1_agent_m0_read),                     //                .read
		.m0_waitrequest          (read_clk_s1_agent_m0_waitrequest),              //                .waitrequest
		.m0_writedata            (read_clk_s1_agent_m0_writedata),                //                .writedata
		.m0_write                (read_clk_s1_agent_m0_write),                    //                .write
		.rp_endofpacket          (read_clk_s1_agent_rp_endofpacket),              //              rp.endofpacket
		.rp_ready                (read_clk_s1_agent_rp_ready),                    //                .ready
		.rp_valid                (read_clk_s1_agent_rp_valid),                    //                .valid
		.rp_data                 (read_clk_s1_agent_rp_data),                     //                .data
		.rp_startofpacket        (read_clk_s1_agent_rp_startofpacket),            //                .startofpacket
		...
		.rf_sink_ready           (read_clk_s1_agent_rsp_fifo_out_ready),          //         rf_sink.ready
		.rf_sink_valid           (read_clk_s1_agent_rsp_fifo_out_valid),          //                .valid
		.rf_sink_startofpacket   (read_clk_s1_agent_rsp_fifo_out_startofpacket),  //                .startofpacket
		.rf_sink_endofpacket     (read_clk_s1_agent_rsp_fifo_out_endofpacket),    //                .endofpacket
		.rf_sink_data            (read_clk_s1_agent_rsp_fifo_out_data),           //                .data
		.rf_source_ready         (read_clk_s1_agent_rf_source_ready),             //       rf_source.ready
		.rf_source_valid         (read_clk_s1_agent_rf_source_valid),             //                .valid
		.rf_source_startofpacket (read_clk_s1_agent_rf_source_startofpacket),     //                .startofpacket
		.rf_source_endofpacket   (read_clk_s1_agent_rf_source_endofpacket),       //                .endofpacket
		.rf_source_data          (read_clk_s1_agent_rf_source_data),              //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),             // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),             //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),              //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),             //                .error
		.rdata_fifo_src_ready    (read_clk_s1_agent_rdata_fifo_src_ready),        //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (read_clk_s1_agent_rdata_fifo_src_valid),        //                .valid
		.rdata_fifo_src_data     (read_clk_s1_agent_rdata_fifo_src_data),         //                .data
		.m0_response             (2'b00),                                         //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                           //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) read_clk_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                 //       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (read_clk_s1_agent_rf_source_data),              //        in.data
		.in_valid          (read_clk_s1_agent_rf_source_valid),             //          .valid
		.in_ready          (read_clk_s1_agent_rf_source_ready),             //          .ready
		.in_startofpacket  (read_clk_s1_agent_rf_source_startofpacket),     //          .startofpacket
		.in_endofpacket    (read_clk_s1_agent_rf_source_endofpacket),       //          .endofpacket
		.out_data          (read_clk_s1_agent_rsp_fifo_out_data),           //       out.data
		.out_valid         (read_clk_s1_agent_rsp_fifo_out_valid),          //          .valid
		.out_ready         (read_clk_s1_agent_rsp_fifo_out_ready),          //          .ready
		.out_startofpacket (read_clk_s1_agent_rsp_fifo_out_startofpacket),  //          .startofpacket
		.out_endofpacket   (read_clk_s1_agent_rsp_fifo_out_endofpacket),    //          .endofpacket
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                 //             clk.clk
		.reset                   (mm_bridge_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (seed_s1_agent_m0_address),                      //              m0.address
		.m0_burstcount           (seed_s1_agent_m0_burstcount),                   //                .burstcount
		.m0_byteenable           (seed_s1_agent_m0_byteenable),                   //                .byteenable
		.m0_debugaccess          (seed_s1_agent_m0_debugaccess),                  //                .debugaccess
		.m0_lock                 (seed_s1_agent_m0_lock),                         //                .lock
		.m0_readdata             (seed_s1_agent_m0_readdata),                     //                .readdata
		.m0_readdatavalid        (seed_s1_agent_m0_readdatavalid),                //                .readdatavalid
		.m0_read                 (seed_s1_agent_m0_read),                         //                .read
		.m0_waitrequest          (seed_s1_agent_m0_waitrequest),                  //                .waitrequest
		.m0_writedata            (seed_s1_agent_m0_writedata),                    //                .writedata
		.m0_write                (seed_s1_agent_m0_write),                        //                .write
		.rp_endofpacket          (seed_s1_agent_rp_endofpacket),                  //              rp.endofpacket
		.rp_ready                (seed_s1_agent_rp_ready),                        //                .ready
		.rp_valid                (seed_s1_agent_rp_valid),                        //                .valid
		.rp_data                 (seed_s1_agent_rp_data),                         //                .data
		.rp_startofpacket        (seed_s1_agent_rp_startofpacket),                //                .startofpacket
		...
		.rf_sink_ready           (seed_s1_agent_rsp_fifo_out_ready),              //         rf_sink.ready
		.rf_sink_valid           (seed_s1_agent_rsp_fifo_out_valid),              //                .valid
		.rf_sink_startofpacket   (seed_s1_agent_rsp_fifo_out_startofpacket),      //                .startofpacket
		.rf_sink_endofpacket     (seed_s1_agent_rsp_fifo_out_endofpacket),        //                .endofpacket
		.rf_sink_data            (seed_s1_agent_rsp_fifo_out_data),               //                .data
		.rf_source_ready         (seed_s1_agent_rf_source_ready),                 //       rf_source.ready
		.rf_source_valid         (seed_s1_agent_rf_source_valid),                 //                .valid
		.rf_source_startofpacket (seed_s1_agent_rf_source_startofpacket),         //                .startofpacket
		.rf_source_endofpacket   (seed_s1_agent_rf_source_endofpacket),           //                .endofpacket
		.rf_source_data          (seed_s1_agent_rf_source_data),                  //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_007_out_0_ready),             // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_007_out_0_valid),             //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_007_out_0_data),              //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_007_out_0_error),             //                .error
		.rdata_fifo_src_ready    (seed_s1_agent_rdata_fifo_src_ready),            //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (seed_s1_agent_rdata_fifo_src_valid),            //                .valid
		.rdata_fifo_src_data     (seed_s1_agent_rdata_fifo_src_data),             //                .data
		.m0_response             (2'b00),                                         //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                           //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) seed_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                 //       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (seed_s1_agent_rf_source_data),                  //        in.data
		.in_valid          (seed_s1_agent_rf_source_valid),                 //          .valid
		.in_ready          (seed_s1_agent_rf_source_ready),                 //          .ready
		.in_startofpacket  (seed_s1_agent_rf_source_startofpacket),         //          .startofpacket
		.in_endofpacket    (seed_s1_agent_rf_source_endofpacket),           //          .endofpacket
		.out_data          (seed_s1_agent_rsp_fifo_out_data),               //       out.data
		.out_valid         (seed_s1_agent_rsp_fifo_out_valid),              //          .valid
		.out_ready         (seed_s1_agent_rsp_fifo_out_ready),              //          .ready
		.out_startofpacket (seed_s1_agent_rsp_fifo_out_startofpacket),      //          .startofpacket
		.out_endofpacket   (seed_s1_agent_rsp_fifo_out_endofpacket),        //          .endofpacket
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                 //             clk.clk
		.reset                   (mm_bridge_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (prng_out_s1_agent_m0_address),                  //              m0.address
		.m0_burstcount           (prng_out_s1_agent_m0_burstcount),               //                .burstcount
		.m0_byteenable           (prng_out_s1_agent_m0_byteenable),               //                .byteenable
		.m0_debugaccess          (prng_out_s1_agent_m0_debugaccess),              //                .debugaccess
		.m0_lock                 (prng_out_s1_agent_m0_lock),                     //                .lock
		.m0_readdata             (prng_out_s1_agent_m0_readdata),                 //                .readdata
		.m0_readdatavalid        (prng_out_s1_agent_m0_readdatavalid),            //                .readdatavalid
		.m0_read                 (prng_out_s1_agent_m0_read),                     //                .read
		.m0_waitrequest          (prng_out_s1_agent_m0_waitrequest),              //                .waitrequest
		.m0_writedata            (prng_out_s1_agent_m0_writedata),                //                .writedata
		.m0_write                (prng_out_s1_agent_m0_write),                    //                .write
		.rp_endofpacket          (prng_out_s1_agent_rp_endofpacket),              //              rp.endofpacket
		.rp_ready                (prng_out_s1_agent_rp_ready),                    //                .ready
		.rp_valid                (prng_out_s1_agent_rp_valid),                    //                .valid
		.rp_data                 (prng_out_s1_agent_rp_data),                     //                .data
		.rp_startofpacket        (prng_out_s1_agent_rp_startofpacket),            //                .startofpacket
		...
		.rf_sink_ready           (prng_out_s1_agent_rsp_fifo_out_ready),          //         rf_sink.ready
		.rf_sink_valid           (prng_out_s1_agent_rsp_fifo_out_valid),          //                .valid
		.rf_sink_startofpacket   (prng_out_s1_agent_rsp_fifo_out_startofpacket),  //                .startofpacket
		.rf_sink_endofpacket     (prng_out_s1_agent_rsp_fifo_out_endofpacket),    //                .endofpacket
		.rf_sink_data            (prng_out_s1_agent_rsp_fifo_out_data),           //                .data
		.rf_source_ready         (prng_out_s1_agent_rf_source_ready),             //       rf_source.ready
		.rf_source_valid         (prng_out_s1_agent_rf_source_valid),             //                .valid
		.rf_source_startofpacket (prng_out_s1_agent_rf_source_startofpacket),     //                .startofpacket
		.rf_source_endofpacket   (prng_out_s1_agent_rf_source_endofpacket),       //                .endofpacket
		.rf_source_data          (prng_out_s1_agent_rf_source_data),              //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_008_out_0_ready),             // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_008_out_0_valid),             //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_008_out_0_data),              //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_008_out_0_error),             //                .error
		.rdata_fifo_src_ready    (prng_out_s1_agent_rdata_fifo_src_ready),        //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (prng_out_s1_agent_rdata_fifo_src_valid),        //                .valid
		.rdata_fifo_src_data     (prng_out_s1_agent_rdata_fifo_src_data),         //                .data
		.m0_response             (2'b00),                                         //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                           //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) prng_out_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                 //       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (prng_out_s1_agent_rf_source_data),              //        in.data
		.in_valid          (prng_out_s1_agent_rf_source_valid),             //          .valid
		.in_ready          (prng_out_s1_agent_rf_source_ready),             //          .ready
		.in_startofpacket  (prng_out_s1_agent_rf_source_startofpacket),     //          .startofpacket
		.in_endofpacket    (prng_out_s1_agent_rf_source_endofpacket),       //          .endofpacket
		.out_data          (prng_out_s1_agent_rsp_fifo_out_data),           //       out.data
		.out_valid         (prng_out_s1_agent_rsp_fifo_out_valid),          //          .valid
		.out_ready         (prng_out_s1_agent_rsp_fifo_out_ready),          //          .ready
		.out_startofpacket (prng_out_s1_agent_rsp_fifo_out_startofpacket),  //          .startofpacket
		.out_endofpacket   (prng_out_s1_agent_rsp_fifo_out_endofpacket),    //          .endofpacket
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                 //             clk.clk
		.reset                   (mm_bridge_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (fsm_reset_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (fsm_reset_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (fsm_reset_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (fsm_reset_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (fsm_reset_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (fsm_reset_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (fsm_reset_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (fsm_reset_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (fsm_reset_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (fsm_reset_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (fsm_reset_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (fsm_reset_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (fsm_reset_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (fsm_reset_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (fsm_reset_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (fsm_reset_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (fsm_reset_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (fsm_reset_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (fsm_reset_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (fsm_reset_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (fsm_reset_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (fsm_reset_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (fsm_reset_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (fsm_reset_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (fsm_reset_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (fsm_reset_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_009_out_0_ready),             // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_009_out_0_valid),             //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_009_out_0_data),              //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_009_out_0_error),             //                .error
		.rdata_fifo_src_ready    (fsm_reset_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (fsm_reset_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (fsm_reset_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                         //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                           //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) fsm_reset_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                 //       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (fsm_reset_s1_agent_rf_source_data),             //        in.data
		.in_valid          (fsm_reset_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (fsm_reset_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (fsm_reset_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (fsm_reset_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (fsm_reset_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (fsm_reset_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (fsm_reset_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (fsm_reset_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (fsm_reset_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (mm_bridge_0_reset_reset_bridge_in_reset_reset),  //       clk_reset.reset
		.m0_address              (prng_start_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (prng_start_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (prng_start_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (prng_start_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (prng_start_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (prng_start_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (prng_start_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (prng_start_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (prng_start_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (prng_start_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (prng_start_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (prng_start_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (prng_start_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (prng_start_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (prng_start_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (prng_start_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (prng_start_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (prng_start_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (prng_start_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (prng_start_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (prng_start_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (prng_start_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (prng_start_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (prng_start_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (prng_start_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (prng_start_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_010_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_010_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_010_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_010_out_0_error),              //                .error
		.rdata_fifo_src_ready    (prng_start_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (prng_start_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (prng_start_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) prng_start_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
		.in_data           (prng_start_s1_agent_rf_source_data),             //        in.data
		.in_valid          (prng_start_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (prng_start_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (prng_start_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (prng_start_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (prng_start_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (prng_start_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (prng_start_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (prng_start_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (prng_start_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                 //             clk.clk
		.reset                   (mm_bridge_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (rec_done_s1_agent_m0_address),                  //              m0.address
		.m0_burstcount           (rec_done_s1_agent_m0_burstcount),               //                .burstcount
		.m0_byteenable           (rec_done_s1_agent_m0_byteenable),               //                .byteenable
		.m0_debugaccess          (rec_done_s1_agent_m0_debugaccess),              //                .debugaccess
		.m0_lock                 (rec_done_s1_agent_m0_lock),                     //                .lock
		.m0_readdata             (rec_done_s1_agent_m0_readdata),                 //                .readdata
		.m0_readdatavalid        (rec_done_s1_agent_m0_readdatavalid),            //                .readdatavalid
		.m0_read                 (rec_done_s1_agent_m0_read),                     //                .read
		.m0_waitrequest          (rec_done_s1_agent_m0_waitrequest),              //                .waitrequest
		.m0_writedata            (rec_done_s1_agent_m0_writedata),                //                .writedata
		.m0_write                (rec_done_s1_agent_m0_write),                    //                .write
		.rp_endofpacket          (rec_done_s1_agent_rp_endofpacket),              //              rp.endofpacket
		.rp_ready                (rec_done_s1_agent_rp_ready),                    //                .ready
		.rp_valid                (rec_done_s1_agent_rp_valid),                    //                .valid
		.rp_data                 (rec_done_s1_agent_rp_data),                     //                .data
		.rp_startofpacket        (rec_done_s1_agent_rp_startofpacket),            //                .startofpacket
		...
		.rf_sink_ready           (rec_done_s1_agent_rsp_fifo_out_ready),          //         rf_sink.ready
		.rf_sink_valid           (rec_done_s1_agent_rsp_fifo_out_valid),          //                .valid
		.rf_sink_startofpacket   (rec_done_s1_agent_rsp_fifo_out_startofpacket),  //                .startofpacket
		.rf_sink_endofpacket     (rec_done_s1_agent_rsp_fifo_out_endofpacket),    //                .endofpacket
		.rf_sink_data            (rec_done_s1_agent_rsp_fifo_out_data),           //                .data
		.rf_source_ready         (rec_done_s1_agent_rf_source_ready),             //       rf_source.ready
		.rf_source_valid         (rec_done_s1_agent_rf_source_valid),             //                .valid
		.rf_source_startofpacket (rec_done_s1_agent_rf_source_startofpacket),     //                .startofpacket
		.rf_source_endofpacket   (rec_done_s1_agent_rf_source_endofpacket),       //                .endofpacket
		.rf_source_data          (rec_done_s1_agent_rf_source_data),              //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_011_out_0_ready),             // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_011_out_0_valid),             //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_011_out_0_data),              //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_011_out_0_error),             //                .error
		.rdata_fifo_src_ready    (rec_done_s1_agent_rdata_fifo_src_ready),        //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (rec_done_s1_agent_rdata_fifo_src_valid),        //                .valid
		.rdata_fifo_src_data     (rec_done_s1_agent_rdata_fifo_src_data),         //                .data
		.m0_response             (2'b00),                                         //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                           //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) rec_done_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                 //       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (rec_done_s1_agent_rf_source_data),              //        in.data
		.in_valid          (rec_done_s1_agent_rf_source_valid),             //          .valid
		.in_ready          (rec_done_s1_agent_rf_source_ready),             //          .ready
		.in_startofpacket  (rec_done_s1_agent_rf_source_startofpacket),     //          .startofpacket
		.in_endofpacket    (rec_done_s1_agent_rf_source_endofpacket),       //          .endofpacket
		.out_data          (rec_done_s1_agent_rsp_fifo_out_data),           //       out.data
		.out_valid         (rec_done_s1_agent_rsp_fifo_out_valid),          //          .valid
		.out_ready         (rec_done_s1_agent_rsp_fifo_out_ready),          //          .ready
		.out_startofpacket (rec_done_s1_agent_rsp_fifo_out_startofpacket),  //          .startofpacket
		.out_endofpacket   (rec_done_s1_agent_rsp_fifo_out_endofpacket),    //          .endofpacket
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                 //             clk.clk
		.reset                   (mm_bridge_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (r_addr_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (r_addr_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (r_addr_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (r_addr_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (r_addr_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (r_addr_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (r_addr_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (r_addr_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (r_addr_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (r_addr_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (r_addr_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (r_addr_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (r_addr_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (r_addr_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (r_addr_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (r_addr_s1_agent_rp_startofpacket),              //                .startofpacket
		...
		.rf_sink_ready           (r_addr_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (r_addr_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (r_addr_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (r_addr_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (r_addr_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (r_addr_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (r_addr_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (r_addr_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (r_addr_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (r_addr_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_012_out_0_ready),             // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_012_out_0_valid),             //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_012_out_0_data),              //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_012_out_0_error),             //                .error
		.rdata_fifo_src_ready    (r_addr_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (r_addr_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (r_addr_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                         //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                           //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) r_addr_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                 //       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (r_addr_s1_agent_rf_source_data),                //        in.data
		.in_valid          (r_addr_s1_agent_rf_source_valid),               //          .valid
		.in_ready          (r_addr_s1_agent_rf_source_ready),               //          .ready
		.in_startofpacket  (r_addr_s1_agent_rf_source_startofpacket),       //          .startofpacket
		.in_endofpacket    (r_addr_s1_agent_rf_source_endofpacket),         //          .endofpacket
		.out_data          (r_addr_s1_agent_rsp_fifo_out_data),             //       out.data
		.out_valid         (r_addr_s1_agent_rsp_fifo_out_valid),            //          .valid
		.out_ready         (r_addr_s1_agent_rsp_fifo_out_ready),            //          .ready
		.out_startofpacket (r_addr_s1_agent_rsp_fifo_out_startofpacket),    //          .startofpacket
		.out_endofpacket   (r_addr_s1_agent_rsp_fifo_out_endofpacket),      //          .endofpacket
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                 //             clk.clk
		.reset                   (mm_bridge_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (gen_done_s1_agent_m0_address),                  //              m0.address
		.m0_burstcount           (gen_done_s1_agent_m0_burstcount),               //                .burstcount
		.m0_byteenable           (gen_done_s1_agent_m0_byteenable),               //                .byteenable
		.m0_debugaccess          (gen_done_s1_agent_m0_debugaccess),              //                .debugaccess
		.m0_lock                 (gen_done_s1_agent_m0_lock),                     //                .lock
		.m0_readdata             (gen_done_s1_agent_m0_readdata),                 //                .readdata
		.m0_readdatavalid        (gen_done_s1_agent_m0_readdatavalid),            //                .readdatavalid
		.m0_read                 (gen_done_s1_agent_m0_read),                     //                .read
		.m0_waitrequest          (gen_done_s1_agent_m0_waitrequest),              //                .waitrequest
		.m0_writedata            (gen_done_s1_agent_m0_writedata),                //                .writedata
		.m0_write                (gen_done_s1_agent_m0_write),                    //                .write
		.rp_endofpacket          (gen_done_s1_agent_rp_endofpacket),              //              rp.endofpacket
		.rp_ready                (gen_done_s1_agent_rp_ready),                    //                .ready
		.rp_valid                (gen_done_s1_agent_rp_valid),                    //                .valid
		.rp_data                 (gen_done_s1_agent_rp_data),                     //                .data
		.rp_startofpacket        (gen_done_s1_agent_rp_startofpacket),            //                .startofpacket
		...
		.rf_sink_ready           (gen_done_s1_agent_rsp_fifo_out_ready),          //         rf_sink.ready
		.rf_sink_valid           (gen_done_s1_agent_rsp_fifo_out_valid),          //                .valid
		.rf_sink_startofpacket   (gen_done_s1_agent_rsp_fifo_out_startofpacket),  //                .startofpacket
		.rf_sink_endofpacket     (gen_done_s1_agent_rsp_fifo_out_endofpacket),    //                .endofpacket
		.rf_sink_data            (gen_done_s1_agent_rsp_fifo_out_data),           //                .data
		.rf_source_ready         (gen_done_s1_agent_rf_source_ready),             //       rf_source.ready
		.rf_source_valid         (gen_done_s1_agent_rf_source_valid),             //                .valid
		.rf_source_startofpacket (gen_done_s1_agent_rf_source_startofpacket),     //                .startofpacket
		.rf_source_endofpacket   (gen_done_s1_agent_rf_source_endofpacket),       //                .endofpacket
		.rf_source_data          (gen_done_s1_agent_rf_source_data),              //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_013_out_0_ready),             // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_013_out_0_valid),             //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_013_out_0_data),              //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_013_out_0_error),             //                .error
		.rdata_fifo_src_ready    (gen_done_s1_agent_rdata_fifo_src_ready),        //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (gen_done_s1_agent_rdata_fifo_src_valid),        //                .valid
		.rdata_fifo_src_data     (gen_done_s1_agent_rdata_fifo_src_data),         //                .data
		.m0_response             (2'b00),                                         //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                           //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) gen_done_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                 //       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (gen_done_s1_agent_rf_source_data),              //        in.data
		.in_valid          (gen_done_s1_agent_rf_source_valid),             //          .valid
		.in_ready          (gen_done_s1_agent_rf_source_ready),             //          .ready
		.in_startofpacket  (gen_done_s1_agent_rf_source_startofpacket),     //          .startofpacket
		.in_endofpacket    (gen_done_s1_agent_rf_source_endofpacket),       //          .endofpacket
		.out_data          (gen_done_s1_agent_rsp_fifo_out_data),           //       out.data
		.out_valid         (gen_done_s1_agent_rsp_fifo_out_valid),          //          .valid
		.out_ready         (gen_done_s1_agent_rsp_fifo_out_ready),          //          .ready
		.out_startofpacket (gen_done_s1_agent_rsp_fifo_out_startofpacket),  //          .startofpacket
		.out_endofpacket   (gen_done_s1_agent_rsp_fifo_out_endofpacket),    //          .endofpacket
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	soc_system_mm_interconnect_1_router_002 router_008 (
		.sink_ready         (read_clk_s1_agent_rp_ready),                    //      sink.ready
		.sink_valid         (read_clk_s1_agent_rp_valid),                    //          .valid
		.sink_data          (read_clk_s1_agent_rp_data),                     //          .data
		.sink_startofpacket (read_clk_s1_agent_rp_startofpacket),            //          .startofpacket
		.sink_endofpacket   (read_clk_s1_agent_rp_endofpacket),              //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_1_router_002 router_009 (
		.sink_ready         (seed_s1_agent_rp_ready),                        //      sink.ready
		.sink_valid         (seed_s1_agent_rp_valid),                        //          .valid
		.sink_data          (seed_s1_agent_rp_data),                         //          .data
		.sink_startofpacket (seed_s1_agent_rp_startofpacket),                //          .startofpacket
		.sink_endofpacket   (seed_s1_agent_rp_endofpacket),                  //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_1_router_002 router_010 (
		.sink_ready         (prng_out_s1_agent_rp_ready),                    //      sink.ready
		.sink_valid         (prng_out_s1_agent_rp_valid),                    //          .valid
		.sink_data          (prng_out_s1_agent_rp_data),                     //          .data
		.sink_startofpacket (prng_out_s1_agent_rp_startofpacket),            //          .startofpacket
		.sink_endofpacket   (prng_out_s1_agent_rp_endofpacket),              //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_1_router_002 router_011 (
		.sink_ready         (fsm_reset_s1_agent_rp_ready),                   //      sink.ready
		.sink_valid         (fsm_reset_s1_agent_rp_valid),                   //          .valid
		.sink_data          (fsm_reset_s1_agent_rp_data),                    //          .data
		.sink_startofpacket (fsm_reset_s1_agent_rp_startofpacket),           //          .startofpacket
		.sink_endofpacket   (fsm_reset_s1_agent_rp_endofpacket),             //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_1_router_002 router_012 (
		.sink_ready         (prng_start_s1_agent_rp_ready),                  //      sink.ready
		.sink_valid         (prng_start_s1_agent_rp_valid),                  //          .valid
		.sink_data          (prng_start_s1_agent_rp_data),                   //          .data
		.sink_startofpacket (prng_start_s1_agent_rp_startofpacket),          //          .startofpacket
		.sink_endofpacket   (prng_start_s1_agent_rp_endofpacket),            //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_1_router_002 router_013 (
		.sink_ready         (rec_done_s1_agent_rp_ready),                    //      sink.ready
		.sink_valid         (rec_done_s1_agent_rp_valid),                    //          .valid
		.sink_data          (rec_done_s1_agent_rp_data),                     //          .data
		.sink_startofpacket (rec_done_s1_agent_rp_startofpacket),            //          .startofpacket
		.sink_endofpacket   (rec_done_s1_agent_rp_endofpacket),              //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_1_router_002 router_014 (
		.sink_ready         (r_addr_s1_agent_rp_ready),                      //      sink.ready
		.sink_valid         (r_addr_s1_agent_rp_valid),                      //          .valid
		.sink_data          (r_addr_s1_agent_rp_data),                       //          .data
		.sink_startofpacket (r_addr_s1_agent_rp_startofpacket),              //          .startofpacket
		.sink_endofpacket   (r_addr_s1_agent_rp_endofpacket),                //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_1_router_002 router_015 (
		.sink_ready         (gen_done_s1_agent_rp_ready),                    //      sink.ready
		.sink_valid         (gen_done_s1_agent_rp_valid),                    //          .valid
		.sink_data          (gen_done_s1_agent_rp_data),                     //          .data
		.sink_startofpacket (gen_done_s1_agent_rp_startofpacket),            //          .startofpacket
		.sink_endofpacket   (gen_done_s1_agent_rp_endofpacket),              //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (mm_bridge_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (read_clk_s1_agent_rdata_fifo_src_data),         //     in_0.data
		.in_0_valid     (read_clk_s1_agent_rdata_fifo_src_valid),        //         .valid
		.in_0_ready     (read_clk_s1_agent_rdata_fifo_src_ready),        //         .ready
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (mm_bridge_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (seed_s1_agent_rdata_fifo_src_data),             //     in_0.data
		.in_0_valid     (seed_s1_agent_rdata_fifo_src_valid),            //         .valid
		.in_0_ready     (seed_s1_agent_rdata_fifo_src_ready),            //         .ready
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (mm_bridge_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (prng_out_s1_agent_rdata_fifo_src_data),         //     in_0.data
		.in_0_valid     (prng_out_s1_agent_rdata_fifo_src_valid),        //         .valid
		.in_0_ready     (prng_out_s1_agent_rdata_fifo_src_ready),        //         .ready
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (mm_bridge_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (fsm_reset_s1_agent_rdata_fifo_src_data),        //     in_0.data
		.in_0_valid     (fsm_reset_s1_agent_rdata_fifo_src_valid),       //         .valid
		.in_0_ready     (fsm_reset_s1_agent_rdata_fifo_src_ready),       //         .ready
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (mm_bridge_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (prng_start_s1_agent_rdata_fifo_src_data),       //     in_0.data
		.in_0_valid     (prng_start_s1_agent_rdata_fifo_src_valid),      //         .valid
		.in_0_ready     (prng_start_s1_agent_rdata_fifo_src_ready),      //         .ready
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (mm_bridge_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (rec_done_s1_agent_rdata_fifo_src_data),         //     in_0.data
		.in_0_valid     (rec_done_s1_agent_rdata_fifo_src_valid),        //         .valid
		.in_0_ready     (rec_done_s1_agent_rdata_fifo_src_ready),        //         .ready
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (mm_bridge_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (r_addr_s1_agent_rdata_fifo_src_data),           //     in_0.data
		.in_0_valid     (r_addr_s1_agent_rdata_fifo_src_valid),          //         .valid
		.in_0_ready     (r_addr_s1_agent_rdata_fifo_src_ready),          //         .ready
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (mm_bridge_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (gen_done_s1_agent_rdata_fifo_src_data),         //     in_0.data
		.in_0_valid     (gen_done_s1_agent_rdata_fifo_src_valid),        //         .valid
		.in_0_ready     (gen_done_s1_agent_rdata_fifo_src_ready),        //         .ready
