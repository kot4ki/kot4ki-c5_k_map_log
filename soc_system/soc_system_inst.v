	soc_system u0 (
		...
		.fsm_reset_external_connection_export  (<connected-to-fsm_reset_external_connection_export>),  //  fsm_reset_external_connection.export
		.gen_done_external_connection_export   (<connected-to-gen_done_external_connection_export>),   //   gen_done_external_connection.export
		...
		.prng_out_external_connection_export   (<connected-to-prng_out_external_connection_export>),   //   prng_out_external_connection.export
		.prng_start_external_connection_export (<connected-to-prng_start_external_connection_export>), // prng_start_external_connection.export
		.r_addr_external_connection_export     (<connected-to-r_addr_external_connection_export>),     //     r_addr_external_connection.export
		.read_clk_external_connection_export   (<connected-to-read_clk_external_connection_export>),   //   read_clk_external_connection.export
		.rec_done_external_connection_export   (<connected-to-rec_done_external_connection_export>),   //   rec_done_external_connection.export
		.reset_reset_n                         (<connected-to-reset_reset_n>),                         //                          reset.reset_n
		.seed_external_connection_export       (<connected-to-seed_external_connection_export>)        //       seed_external_connection.export
	);
